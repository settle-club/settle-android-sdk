...
class PermissionHandlerFragment : Fragment() {
    ...
    private fun removeFragmentFromActivity() {
        val isAttachedToActivity =
            isAdded && activity?.supportFragmentManager?.fragments?.contains(this) == true
        val isChildFragment = parentFragmentManager.fragments.contains(this)

        if (isAttachedToActivity) {
            activity?.supportFragmentManager?.commit {
                remove(this@PermissionHandlerFragment)
            }
